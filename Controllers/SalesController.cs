...
namespace Product_Sales_Commision_MVC.Controllers
{
    public class SalesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SalesAgentId"] = new SelectList(_context.SalesAgent, "Id", "AgentName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SalesAgentId,ProductId,Quantity")] Sale sale)
        {
            ...
            ViewData["SalesAgentId"] = new SelectList(_context.SalesAgent, "Id", "AgentName", sale.SalesAgentId);
            return View(sale);
        }
